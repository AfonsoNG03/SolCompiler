...
public class SolLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ASSIGN", "BREAK", "IF", "THEN", "ELSE", "FOR", "TO", "WHILE", "DO", 
			"BEGIN", "END", "TYPEINT", "TYPEDOUBLE", "TYPESTRING", "TYPEBOOL", "MULT", 
			"ADD", "SUB", "DIV", "MOD", "TRUE", "FALSE", "LPAREN", "RPAREN", "NOT", 
			"AND", "OR", "EQ", "NEQ", "LT", "LE", "GT", "GE", "INT", "DOUBLE", "STRING", 
			"PRINT", "SEMICOLON", "COMMA", "ID", "WS", "SL_COMMENT", "ML_COMMENT", 
			"DIGIT", "ESC"
		};
	}
